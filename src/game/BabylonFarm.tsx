...
export default function BabylonFarm() {
  ...
  useEffect(() => {
    ...
    const pigEntity: AnimalEntity = { id: "pig", name: "Pig", soundUrl: olaBeerAudio, words: [beer] }
    const sheepEntity: AnimalEntity = { id: "sheep", name: "Sheep", soundUrl: beer.audioUrl, words: [beer] }
    const horseEntity: AnimalEntity = { id: "horse", name: "Horse", words: [beer] }
    const chickenEntity: AnimalEntity = { id: "chicken", name: "Chicken", soundUrl: oinkBeerAudio, words: [beer] }
    ...
    const canSpeak = (entity: AnimalEntity) => Boolean(entity.soundUrl || (entity.words && entity.words.length > 0))
    ...
    const update = (delta: number) => {
      ...
      if (nearestAnimal && nearestAnimal.dist < 3.5) {
